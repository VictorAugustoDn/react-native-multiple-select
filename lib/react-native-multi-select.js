...
export default class MultiSelect extends Component {
  ...
  _getSelectLabel = () => {
    ...
    return `${selectText} (${selectedItems.length} ${selectedItems.length > 1 ? 'selecionados' : 'selecionado'})`;
  };
      ...
      return (
        <View
          style={[
            styles.selectedItem,
            {
              width: item[displayKey].length * 8 + 65,
          ...
          >
            ...
            >
              <TextInput
                ...
                style={[searchInputStyle, { flex: 1, margin: 0, padding: 0 }]}
                value={searchTerm}
                {...textInputProps}
              />
              {hideSubmitButton && (
